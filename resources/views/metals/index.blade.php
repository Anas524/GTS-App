...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/metals.css?v=15') }}">
...
<body class="bg-slate-50 text-slate-900">
    ...
    <header class="bg-white border-b border-slate-200">
      <div class="max-w-7xl mx-auto px-2 py-2 flex items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2 text-sm">
          ...
          <span class="text-slate-500">Metals Ledger</span>
        </div>
                    ...
                    <div class="col-span-8 p-4">
                        <div id="attPreviewBox" class="bg-slate-50 border border-slate-200 rounded-xl h-[440px] overflow-auto">
                            ...
                            <div id="attPreviewImgWrap" class="hidden">
                                <img id="attPreviewImg" class="hidden" />
                            </div>
    ...
    <script src="{{ asset('js/metals.js?v=21') }}"></script>
