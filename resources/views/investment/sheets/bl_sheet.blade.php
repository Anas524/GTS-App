...
<div class="bl-client-wrapper px-3 py-5" style="background-color: #f5faff; min-height: 100vh;">
    <div class="container" style="max-width: 720px;">
        <div class="card shadow-lg border-0 mb-4">
            <div class="card-body">
                <h4 class="card-title text-center mb-4 text-dark fw-bold"> Add BL Sheet Entry</h4>
        ...
        <!-- Summary Card -->
        <div class="bg-light shadow rounded-4 p-4 mb-4 border-start border-5 border-start" style="border-left: 5px solid #7e22ce !important;">
